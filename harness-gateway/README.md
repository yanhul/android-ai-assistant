...
This repository contains the protocol/contract only. The Android device is the SMS transport; it must not hold GitHub write credentials. A control server/worker is the authority boundary.
